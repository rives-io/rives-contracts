...
contract TapeFeeModel is ITapeFeeModel {
    ...
    function getMintFees(uint256, uint256 totalPrice)
        external
        pure
        override
    ...
    function getBurnFees(uint256, uint256 totalPrice)
        external
        pure
        override
        returns (uint256, uint256, uint256, uint256)
    ...
    function getTapesRoyaltiesFeesDistribution(uint256, uint256) external pure override returns (uint256[] memory) {
