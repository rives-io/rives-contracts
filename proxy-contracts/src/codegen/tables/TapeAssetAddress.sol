...
library TapeAssetAddress {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "core", name: "TapeAssetAddress", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636f72650000000000000000000054617065417373657441646472657373);
