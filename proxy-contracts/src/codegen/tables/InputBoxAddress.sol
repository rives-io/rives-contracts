...
library InputBoxAddress {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "core", name: "InputBoxAddress", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636f726500000000000000000000496e707574426f784164647265737300);
